...
powershell Compress-Archive -Path "C:\workspace\Projector\Projector\Projector-server\aPublic_folder\update\*" -DestinationPath "%~dp0projectorUpdate103.zip" -Force
